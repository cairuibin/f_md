...
![img](https://ss3.baidu.com/-fo3dSag_xI4khGko9WTAnF6hhy/zhidao/pic/item/5366d0160924ab18c1375d8835fae6cd7b890b6f.jpg)
...
<body>
    ...
    <script>
       function addClassInPre(){
          document.querySelectorAll('#content pre').forEach(v=>{
              console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v) console.log(v)
              v.classList.add('hljs')
          })
       };
        window.onload = () => {
            axios.get('/uu').then((r) => {
    ...
    <!-- <script src="./heightlight/prism.js"></script> -->
</body>
